...
export function writeCoreMatchSourceTrace(x: CoreMatchSourceTrace, context: any = x): any {
  return {
...
export function readCoreMatchSourceTrace(x: any, context: any = x): CoreMatchSourceTrace {
  return {
...
export function writeCoreMatchDataflowTrace(x: CoreMatchDataflowTrace, context: any = x): any {
  return {
    'taint_sources': _atd_write_optional_field(_atd_write_array(writeCoreMatchSourceTrace), x.taint_sources, x),
...
export function readCoreMatchDataflowTrace(x: any, context: any = x): CoreMatchDataflowTrace {
  return {
    taint_sources: _atd_read_optional_field(_atd_read_array(readCoreMatchSourceTrace), x['taint_sources'], x),
